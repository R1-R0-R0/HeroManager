...
public class LegsEquipment implements Equipment{
    ...
    public LegsEquipment(String name, String description, int armorBonus, EquipmentEffect effect, EquipmentType type,
