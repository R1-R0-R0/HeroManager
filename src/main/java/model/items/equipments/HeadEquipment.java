...
public class HeadEquipment implements Equipment{
    ...
    public HeadEquipment(String name, String description, int armorBonus, EquipmentEffect effect, EquipmentType type,
