    ...
    public static List<Spell> getSpells() {
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                switch (i % 10){
                    case 0 : names.add((String)jsonArray.get(i));
                    case 1 : descriptions.add((String)jsonArray.get(i));
                    case 2 : school.add((String)jsonArray.get(i));
                    case 3 : castingTimes.add((String)jsonArray.get(i));
                    case 4 : duration.add((String)jsonArray.get(i));
                    case 5 : level.add((Integer) jsonArray.get(i));
                    case 6 : range.add((Integer) jsonArray.get(i));
                    case 7 : switch ((String) jsonArray.get(i)){
                    ...
                    case 8 : doDamages.add((Boolean) jsonArray.get(i));
                    case 9 :{ JSONArray comp = (JSONArray) jsonArray.get(i);
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {{
                switch (count % 12) {
                    ...
                    case 2: switch ((String) jsonArray.get(i)){
                        case "HEAD" : equipmentPart.add(EquipmentParts.HEAD);
                        case "BODY" : equipmentPart.add(EquipmentParts.BODY);
                        case "BELT" : equipmentPart.add(EquipmentParts.BELT);
                        case "LEGS" : equipmentPart.add(EquipmentParts.LEGS);
                        case "FEET" : equipmentPart.add(EquipmentParts.FEET);
                        case "AMULET" : equipmentPart.add(EquipmentParts.AMULET);
                        case "HANDS" : equipmentPart.add(EquipmentParts.HANDS);
                        case "MANTLE" : equipmentPart.add(EquipmentParts.MANTLE);
                        case "RING" : equipmentPart.add(EquipmentParts.RING);
                    }
                    case 3 : armorBonus.add((Integer) jsonArray.get(i));
                    case 4 :  switch ((String) jsonArray.get(i)){
                    ...
                    case 5 : strengthBoost.add((Integer) jsonArray.get(i));
                    case 6 : dexterityBoost.add((Integer) jsonArray.get(i));
                    case 7 : robustnessBoost.add((Integer) jsonArray.get(i));
                    case 8 : intelligenceBoost.add((Integer) jsonArray.get(i));
                    case 9 : wisdomBoost.add((Integer) jsonArray.get(i));
                    case 10 : charismaBoost.add((Integer) jsonArray.get(i));
                    case 11 : speedBoost.add((Integer) jsonArray.get(i));
        ...
        try {
            ...
            for (int i = 0; i < jsonArray.size(); i++) {
                switch (i % 22){
                    ...
                    case 3 : switch ((String) jsonArray.get(i)){
                    ...
                    case 4 : races.add((Race) jsonArray.get(i));
                    case 5 : switch ((String) jsonArray.get(i)){
                        case "BARBARIAN" : jobTypes.add(JobType.BARBARIAN);
                        case "BARD" : jobTypes.add(JobType.BARD);
                        case "CLERIC" : jobTypes.add(JobType.CLERIC);
                        case "DRUID" : jobTypes.add(JobType.DRUID);
                    ...
                    case 7 :{
                        ...
                        for (int y =0 ; y < skill.size();y++){
                            switch (y % 3){
                                case 0 : name.add((String) skill.get(y));
                                case 1 : mastered.add((Boolean) skill.get(y));
                                case 2 : switch ((String) skill.get(y)){
                                    case "STRENGTH" : cara.add(Characteristics.STRENGTH);
                                    case "DEXTERITY" : cara.add(Characteristics.DEXTERITY);
                                    case "ROBUSTNESS" : cara.add(Characteristics.ROBUSTNESS);
                                    case "INTELLIGENCE" : cara.add(Characteristics.INTELLIGENCE);
                                    case "WISDOM" : cara.add(Characteristics.WISDOM);
                                    case "CHARISMA" : cara.add(Characteristics.CHARISMA);
                    ...
                    case 8 : level.add((Integer) jsonArray.get(i));
                    case 9 : strength.add((Integer) jsonArray.get(i));
                    case 10 : dexterity.add((Integer) jsonArray.get(i));
                    case 11 : robustness.add((Integer) jsonArray.get(i));
                    case 12 : intelligence.add((Integer) jsonArray.get(i));
                    case 13 : wisdom.add((Integer) jsonArray.get(i));
                    case 14 : charisma.add((Integer) jsonArray.get(i));
                    case 15 : speed.add((Integer) jsonArray.get(i));
                    case 16 : hp.add((Integer) jsonArray.get(i));
                    case 17 : armor.add((Integer) jsonArray.get(i));
                    case 18 : points.add((Integer) jsonArray.get(i));
                    case 19 :{
                        ...
                        for (int y =0 ; y < improvment.size();y++){
                            switch( (String) improvment.get(y)){
                                ...
                                case "Tool Proficiency" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Stonecunning" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Keen Senses" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Fey Ancestry" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Trance" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Lucky" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Brave" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Halfling Nimbleness" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Draconic Ancestry" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Breath Weapon" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case  "Damage Resistance" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Gnome cunning" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Skill Versatility" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case  "Menacing" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Relentless Endurance" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case  "Savage Attacks" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case  "Hellish Resistance" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case  "Infernal Legacy" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case   "Flight" : name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                case "Talons" :name.add(Improvement.DWARVEN_COMBAT_TRAINING);
                                default: name.add(Improvement.DARKVISION);
                            }
                        }
