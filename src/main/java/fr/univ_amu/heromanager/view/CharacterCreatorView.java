...
/**
 * View manager of Character cration's fr.univ_amu.heromanager.view.
 *
...
public class CharacterCreatorView implements View {
     ...
     * When called, fxml fr.univ_amu.heromanager.view, its stage is set up
     *
    ...
    public CharacterCreatorView(Stage owner) {
        try {
            ...
            new Dialog("An error occurred while opening Character Creator fr.univ_amu.heromanager.view", e).showAndWait();
        }
    }
    ...
    /**
     * Used to update image fr.univ_amu.heromanager.view who represents character class
     *
    ...
    /**
     * Used to update image fr.univ_amu.heromanager.view who represents character
     *
     * @param path path to image
     */
    ...
    /**
     * Allows to define skill list fr.univ_amu.heromanager.view elements
     *
