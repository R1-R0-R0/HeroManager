...
import fr.univ_amu.heromanager.model.Dice;
import fr.univ_amu.heromanager.utils.gui.Dialog;
import fr.univ_amu.heromanager.view.DiceView;

import java.util.ArrayList;
import java.util.List;

/**
 * Model of Dice Thrower fr.univ_amu.heromanager.view.
 * Implements all logic and reactions of fr.univ_amu.heromanager.view
 *
 * @see DiceView associated class fr.univ_amu.heromanager.view (MVC pattern)
 * @see fr.univ_amu.heromanager.controller.DiceController associated class fr.univ_amu.heromanager.controller (MVC pattern)
 */
public class DiceModel implements Model {
     ...
     * When called, shows fr.univ_amu.heromanager.view.
     */
    public DiceModel() {
        instance = this;
    ...
    /**
     * With given formula, allows to rolls asked dices and gives result to the fr.univ_amu.heromanager.view, and details of result.
