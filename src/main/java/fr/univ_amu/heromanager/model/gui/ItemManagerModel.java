...
public class ItemManagerModel implements Model {
    ...
    /**
     * Logical method when user selected an item in list fr.univ_amu.heromanager.view
     */
    ...
    /**
     * Called when event item creation is triggered by fr.univ_amu.heromanager.view.
    ...
    /**
     * Called when event item modification is triggered by fr.univ_amu.heromanager.view.
     * If some required fields are empty, an error pop up will be throw
     *
     * @throws UnsupportedItemException when item isn't handled
     */
    ...
    /**
     * Called when event item deletion is triggered by fr.univ_amu.heromanager.view.
